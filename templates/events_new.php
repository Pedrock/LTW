		...
		<div id="content">
			<div class="box center default-width">
				<form id="new-event" action="new" method="POST" enctype="multipart/form-data">
					...
					<div id="error-event-name" class="event-error" <?php if (!empty($_SESSION['NEW']['name'])) echo 'style="display:initial"' ?>>
					...
					<div id="error-event-desc" class="event-error" <?php if (!empty($_SESSION['NEW']['desc'])) echo 'style="display:initial"' ?>>
					...
					<div id="error-event-date" class="event-error" <?php if (!empty($_SESSION['NEW']['date'])) echo 'style="display:initial"' ?>>
					...
					<div id="error-event-image" class="event-error" <?php if (!empty($_SESSION['NEW']['image'])) echo 'style="display:initial"' ?>>
							<?php echo $lang['INVALID_IMAGE'] ?>
					</div>
					<div id="error-event-image-size" class="event-error" <?php if (!empty($_SESSION['NEW']['size'])) echo 'style="display:initial"' ?>>
							<?php echo $lang['IMAGE_SIZE_ERROR'] ?>
					</div>
					<div id="error-event-image-ext" class="event-error" <?php if (!empty($_SESSION['NEW']['ext'])) echo 'style="display:initial"' ?>>
